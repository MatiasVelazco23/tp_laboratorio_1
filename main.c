        ...
        do
        {
            ...
            do{
                ...
                case 2:
                    ...
                    printf("a)Falta el 2do operador para poder realizar la resta, vuelva al menú y seleccione la opción 2.\n");
                ...
                case 3:
                    ...
                    printf("a)Faltan ambos operadores para realizar la resta, vuelva al menú y selecciónelos\n");
                    flagNoSeIngresoOperador=0;
                    break;
                case 4:
